...
import { exigenciasNaoCumpridas } from '../politica-de-senha';
...
export class SenhaService {
  constructor(private readonly pwnedPasswords: SenhasVazadasService) {}
  ...
  async hash(password: string): Promise<string> {
    ...
    if (await this.pwnedPasswords.estaComprometida(password)) {
  ...
  // ---------------------------------------------
  verificarFalsa(password: string): Promise<boolean> {
