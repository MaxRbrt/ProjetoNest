...
export function exigenciasNaoCumpridas(senha: string): string[] {
  const faltas: string[] = [];
  // Array.from conta pontos de código Unicode: com o length nativo, um
  // caractere fora do BMP (um emoji, por exemplo) valeria por dois e a senha
  // pareceria mais longa do que é.
